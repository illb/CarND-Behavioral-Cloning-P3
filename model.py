...
model = Sequential()
model.add(Lambda(lambda x: x / 255.0 - 0.5, input_shape=(160, 320, 6), name='normalization'))
...
if initial_epoch > 0:
    model.load_weights('./checkpoint/train_' + name + '-{:02d}-{:.2f}.hdf5'.format(initial_epoch - 1, 0.08))
